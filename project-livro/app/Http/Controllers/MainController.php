    ...
    }public function envioLogin(Request $request)
{
    $request->validate(
        ...
        ['email.required' => 'O campo e-mail é obrigatório.','email.email' => 'O campo de e-mail deve conter um endereço válido.',
            'email.min'      => 'O campo e-mail deve ter no mínimo 3 caracteres.','senha.required' => 'O campo senha é obrigatório.',
            'senha.min'      => 'O campo senha deve ter no mínimo 6 caracteres.',]
    );
    //BD - Rafofinha :)
